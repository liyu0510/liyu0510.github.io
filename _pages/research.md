...
**Asymmetric Price Competition on Hybrid Platforms: Theory and Evidence from Amazon**  [*(Latest version)*](https://luiseeisfeld.github.io/assets/docs/EisfeldYanYu_HybridPlatformPricing.pdf)<br>
...
with [Philipp Wangner](https://www.pwangner.com/home)  


This paper studies how monetary policy affects the geographic allocation of lending by globally operating banks. We document a rise in banks' home bias during the low-interest-rate period following the Global Financial Crisis and develop a portfolio-based model in which the allocation between domestic and foreign lending depends on bank profitability and the costs of managing cross-border uncertainty.
...
[*(Latest version)*](https://luiseeisfeld.github.io/assets/docs/EisfeldYanYu_HybridPlatformPricing.pdf) <br>
with [Luise Eisfeld](https://luiseeisfeld.github.io/) and [Jun Yan](https://sites.google.com/view/jun-yan)  
